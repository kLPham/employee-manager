...
class EmployeeEditor extends Component {
  ...
  handleChange(prop, val) {
    ...
    var employeeCopy = Object.assign({}, this.state.employee); //make a copy of employee.
    employeeCopy[prop] = val; //use [prop] to access the property of employeeCopy & set it equal to val.
    this.setState({ empoyee: empoyeeCopy });
  }
